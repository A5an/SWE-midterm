...
- PR: `https://github.com/A5an/SWE-midterm/pull/10`. See `docs/evidence/LIN-TEA-11/pr-link.txt`. This evidence remains intentionally anchored to the implementation commit instead of the moving branch head.
...
- `pr-link.txt`: actual GitHub PR URL for the reviewable TEA-11 branch state.
