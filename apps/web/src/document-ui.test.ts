...
assert.match(describeRoleCapabilities("unknown", true, true), /confirm whether this user is an editor or viewer/u);
...
console.log("frontend-document-ui: role inference, permissions, and version sorting helpers passed");
